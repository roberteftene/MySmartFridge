<template>
  <div class="formContainer">
    <q-card class="formCard">
      ...
      <q-input class="formInput" outlined v-model="formData.firstName" label="First name" type="text" />
      <q-input class="formInput" outlined v-model="formData.lastName" label="Last name" type="text" />
      <q-input
        class="formInput"
        label="Password"
      ...
      <q-btn @click="submitRegister" class="registerBtn" style="width: 30%" text-color="white" label="Register" />
    </q-card>
  </div>
</template>
  ...
  methods: {
    validateFormData: function () {
      ...
      if (
        ...
        cogoToast.error("First name should contain only letters and start with a capital letter");
      } else if (!this.formData.lastName.match(regex_name)) {
        cogoToast.error("Last name should contain only letters and start with a capital letter");
